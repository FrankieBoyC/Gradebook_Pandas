"""
Calculates students grades by combining data from many sources.
...
to calculate final grades for the class.
"""
...
normal_dist = stats.norm.pdf(x, loc=final_mean, scale=final_std)
